...
const MovieCard = ({ title, released, plot, ratings, director, actors, poster, genre }) => {
  return (
    <div id='movie-card' className='max-w-7/8 flex flex-col justify-center items-center border-2 [border-image:linear-gradient(to_top_right,#5dba7f,#FCF09A,red,purple,#71CAEE)_1] cursor-pointer'>
      ...
      <p className='text-white text-lg'>Directed By: {director}</p>
      <p className='text-white text-lg'>Stars: {actors}</p>
      <p className='text-white text-lg'>Released: {released}</p>
